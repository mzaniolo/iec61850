...
impl ConnectSpdu {
    ...
    pub fn to_bytes(&self) -> Vec<u8> {
        ...
        //TODO: This is completely wrong. We need to calculate the length of the SPDU dynamically.
        // Reserve space for Length Indicator (LI)
...
impl DataSpdu {
    ...
    pub fn to_bytes(&self) -> Vec<u8> {
        ...
        buffer.extend_from_slice(&[SpduType::GiveTokenData as u8, 0x00, 0x01, 0x00]);
        buffer.extend_from_slice(&self.data);
        buffer
    }
}
