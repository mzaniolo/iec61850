...
pub mod asn1 {
	...
	impl AlternateAccessSelectionSelectAlternateAccessAccessSelectionIndexRange {
		pub fn new(low_index: Unsigned32, number_of_elements: Unsigned32) -> Self {
			Self { low_index, number_of_elements }
		}
	}
	#[doc = " Inner type "]
	#[derive(AsnType, Debug, Clone, Decode, Encode, PartialEq, Eq, Hash)]
	...
	impl AlternateAccessSelectionSelectAlternateAccess {
		pub fn new(
			...
			Self { access_selection, alternate_access }
		}
	}
	#[doc = " Inner type "]
	#[derive(AsnType, Debug, Clone, Decode, Encode, PartialEq, Eq, Hash)]
	...
	impl ConfirmedErrorPDU {
		pub fn new(
			...
			Self { invoke_id, modifier_position, service_error }
		}
	}
	#[derive(AsnType, Debug, Clone, Decode, Encode, PartialEq, Eq, Hash)]
	...
	impl DefineNamedVariableListRequest {
		pub fn new(variable_list_name: ObjectName, list_of_variable: VariableDefs) -> Self {
			Self { variable_list_name, list_of_variable }
		}
	}
	#[derive(AsnType, Debug, Clone, Decode, Encode, PartialEq, Eq, Hash, Copy)]
	...
	impl DeleteNamedVariableListRequest {
		pub fn new(
			...
			Self { scope_of_delete, list_of_variable_list_name, domain_name }
		}
	}
	...
	impl DeleteNamedVariableListResponse {
		pub fn new(number_matched: Unsigned32, number_deleted: Unsigned32) -> Self {
			Self { number_matched, number_deleted }
		}
	}
	#[derive(AsnType, Debug, Clone, Decode, Encode, PartialEq, Eq, Hash)]
	...
	impl DirectoryEntry {
		pub fn new(file_name: FileName, file_attributes: FileAttributes) -> Self {
			Self { file_name, file_attributes }
		}
	}
	#[derive(AsnType, Debug, Clone, Decode, Encode, PartialEq, Eq, Hash)]
	...
	impl FileAttributes {
		pub fn new(size_of_file: Unsigned32, last_modified: Option<GeneralizedTime>) -> Self {
			Self { size_of_file, last_modified }
		}
	}
	#[derive(AsnType, Debug, Clone, Decode, Encode, PartialEq, Eq, Hash)]
	...
	impl FileDirectoryRequest {
		pub fn new(file_specification: Option<FileName>, continue_after: Option<FileName>) -> Self {
			Self { file_specification, continue_after }
		}
	}
	#[derive(AsnType, Debug, Clone, Decode, Encode, PartialEq, Eq, Hash)]
	...
	impl FileDirectoryResponse {
		pub fn new(
			...
			Self { list_of_directory_entry, more_follows }
		}
	}
	...
	impl FileOpenRequest {
		pub fn new(file_name: FileName, initial_position: Unsigned32) -> Self {
			Self { file_name, initial_position }
		}
	}
	#[derive(AsnType, Debug, Clone, Decode, Encode, PartialEq, Eq, Hash)]
	...
	impl GetNameListRequest {
		pub fn new(
			...
			Self { object_class, object_scope, continue_after }
		}
	}
	#[derive(AsnType, Debug, Clone, Decode, Encode, PartialEq, Eq, Hash)]
	...
	impl GetNameListResponse {
		pub fn new(list_of_identifier: SequenceOf<Identifier>, more_follows: bool) -> Self {
			Self { list_of_identifier, more_follows }
		}
	}
	...
	impl GetNamedVariableListAttributesResponse {
		pub fn new(mms_deletable: bool, list_of_variable: VariableDefs) -> Self {
			Self { mms_deletable, list_of_variable }
		}
	}
	#[derive(AsnType, Debug, Clone, Decode, Encode, PartialEq, Eq, Hash)]
	...
	impl GetVariableAccessAttributesResponse {
		pub fn new(mms_deletable: bool, type_specification: TypeSpecification) -> Self {
			Self { mms_deletable, type_specification }
		}
	}
	#[derive(AsnType, Debug, Clone, Decode, Encode, PartialEq, Eq, Hash)]
	#[rasn(delegate)]
	...
	impl InformationReport {
		pub fn new(
			...
			Self { variable_access_specification, list_of_access_result }
		}
	}
	#[derive(AsnType, Debug, Clone, Decode, Encode, PartialEq, Eq, Hash)]
	...
	impl InitiateRequestPDUInitRequestDetail {
		pub fn new(
			...
			Self { proposed_version_number, proposed_parameter_cbb, services_supported_calling }
		}
	}
	#[derive(AsnType, Debug, Clone, Decode, Encode, PartialEq, Eq, Hash)]
	...
	impl InitiateResponsePDUInitResponseDetail {
		pub fn new(
			...
			Self { negotiated_version_number, negotiated_parameter_cbb, services_supported_called }
		}
	}
	#[derive(AsnType, Debug, Clone, Decode, Encode, PartialEq, Eq, Hash)]
	...
	impl ReadRequest {
		pub fn new(
			...
			Self { specification_with_result, variable_access_specification }
		}
	}
	...
	impl RejectPDU {
		pub fn new(
			...
			Self { original_invoke_id, reject_reason }
		}
	}
	#[doc = " Inner type "]
	#[derive(AsnType, Debug, Clone, Decode, Encode, PartialEq, Eq, Hash)]
	...
	impl ServiceError {
		pub fn new(
			...
			Self { error_class, additional_code, additional_description }
		}
	}
	#[derive(AsnType, Debug, Clone, Decode, Encode, PartialEq, Eq, Hash)]
	#[rasn(delegate)]
	...
	impl TypeSpecificationArray {
		pub fn new(
			...
			Self { packed, number_of_elements, element_type }
		}
	}
	...
	impl AnonymousTypeSpecificationStructureComponents {
		pub fn new(component_name: Option<Identifier>, component_type: TypeSpecification) -> Self {
			Self { component_name, component_type }
		}
	}
	#[doc = " Inner type "]
	#[derive(AsnType, Debug, Clone, Decode, Encode, PartialEq, Eq, Hash)]
	...
	pub struct TypeSpecificationStructure {
		#[rasn(tag(context, 0), default = "type_specification_structure_packed_default")]
		pub packed: bool,
		#[rasn(tag(context, 1))]
	...
	impl TypeSpecificationFloatingPoint {
		pub fn new(format_width: Unsigned8, exponent_width: Unsigned8) -> Self {
			Self { format_width, exponent_width }
		}
	}
	#[derive(AsnType, Debug, Clone, Decode, Encode, PartialEq, Eq, Hash)]
	#[rasn(choice)]
	...
	impl AnonymousVariableDefs {
		pub fn new(
			...
			Self { variable_specification, alternate_access }
		}
	}
	#[derive(AsnType, Debug, Clone, Decode, Encode, PartialEq, Eq, Hash)]
	#[rasn(delegate)]
	...
	impl WriteRequest {
		pub fn new(
			...
			Self { variable_access_specification, list_of_data }
		}
	}
	#[doc = " Anonymous SEQUENCE OF member "]
	#[derive(AsnType, Debug, Clone, Decode, Encode, PartialEq, Eq, Hash)]
